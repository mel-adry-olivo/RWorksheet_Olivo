...
firstTest <- sum(mathScore$Grade1) / nrow(math)
firstTest

secondTest <- sum(mathScore$Grade2) / nrow(math)
secondTest

thirdTest <- sum(mathScore$Grade3) / nrow(math)
thirdTest

fourthTest <- sum(mathScore$Grade4) / nrow(math)
fourthTest
...
if (mathScore[4,2] > mathScore[4,3] && mathScore[4,2] > mathScore[4,4] && mathScore[4,2] > mathScore[4,5]) {
  ...
  annieHighest <- mathScore[4,4]
} else {
  annieHighest <- mathScore[4,5]
}
